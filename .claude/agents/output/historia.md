...
- **SendMessage**: Send completion notifications to Levi.
...
|---|---|---|
| Levi | Task completion | Task ID, file locations of all produced formats, any issues encountered |
...
Output: `report.pdf` generated via reportlab. Task completion summary includes the fallback method and any visual differences from the HTML version.
