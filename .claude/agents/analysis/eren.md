...
- **SendMessage**: Send debate submissions to Armin (Phase 4 peer messaging) and completion notifications to Levi.
...
|---|---|---|
| Armin | Phase 4 (each submission) | Debate submission for the current stage |
...
| Armin | Rebuttal or closing | Read opposing arguments, prepare counter-rebuttal |
...
Direct messaging with Armin is permitted ONLY during Phase 4 for debate exchanges. Do not message Armin during Phase 3 (independent analysis). All other communication routes through Levi.
