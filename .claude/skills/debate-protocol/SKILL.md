...
1. **Debate Analyst Pro** reviews the Evidence Dossiers and builds the affirmative case.
2. **Debate Analyst Con** reviews the same Evidence Dossiers and builds the opposing case.
...
```
Round N:
  1. Pro Opening / Continued Argument → saved as round-{N}-pro-opening.md
  2. Con Rebuttal                      → saved as round-{N}-con-rebuttal.md
  3. Pro Counter-Rebuttal              → saved as round-{N}-pro-counter.md
  4. Con Closing                       → saved as round-{N}-con-closing.md
```

Minimum: 1 full round. Commander decides whether additional rounds are needed.
...
## Concessions
{Acknowledge 1+ valid points from the opposing side. Required for all stages except Pro Opening in Round 1.}
...
### Scope Discipline
- Stay within the research topic boundaries defined by the Commander.
- Do not introduce new evidence not present in the Source Registry. If new evidence is needed, request it from the Commander, who may task an Investigator.

## Commander Moderation Protocol

The Commander moderates the debate by:
...
Evidence Dossiers from Investigators Alpha and Beta are available.

### Round 1 — Pro Opening (excerpt)
...
### Round 1 — Con Rebuttal (excerpt)

```markdown
# Round 1 — Con Rebuttal
...
## Concessions
Pro correctly identifies accelerating enterprise adoption as a real trend [SRC-003]. The demand signal is genuine, though it does not guarantee that a new entrant can capture meaningful share.
