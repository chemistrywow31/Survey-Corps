...
- All inter-role handoffs and worklog updates
- Team workflow definition from AGENTS.md
...
- Evaluate whether handoff summaries between agents were clear and complete.
- Check if critical information was lost between phases.
- Assess whether Levi's dispatch prompts included sufficient context.
...
- **Evidence**: {specific assignment label, handoff summary, worklog path, or deliverable reference}
...
- **worklog status update**: Mark review tasks as completed.
- **Levi-mediated handoff**: Return the retrospective report to Levi.
...
### Evidence Check
- Does every dimension score cite at least one specific reference (worklog file:line, worklog path, artifact path, assignment label, or commit)?
