...
- **Levi-mediated handoff**: Return QA Reports and completion notifications to Levi.
...
|---|---|---|
| Levi | QA Report complete | Assignment label, QA Report location, overall assessment (Pass/Fail), issue count by severity |
