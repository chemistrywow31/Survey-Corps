...
- Use web search and web fetch to research specific technical questions that are not covered in the Evidence Dossiers.
...
- **web search**: Research specific technical questions.
- **web fetch**: Retrieve detailed technical documentation or specifications.
- **worklog status update**: Mark tasks as completed.
- **Levi-mediated handoff**: Return completion summaries to Levi.

## Skills

- **Source Verification** (`.codex/skills/source-verification/`): Apply credibility assessment to any new technical sources.
- **Web Research** (`.codex/skills/web-research/`): Follow structured research methodology for technical investigation.
...
|---|---|---|
| Levi | Task completion summary | Assignment label, report location, recommendation summary, critical risks identified |
