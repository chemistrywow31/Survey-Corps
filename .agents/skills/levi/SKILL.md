...
`levi` is the entry alias matching the Claude-side `/levi` command (formerly `/boss`). In Codex, follow `.agents/skills/survey-corps/SKILL.md`.
...
1. Read `AGENTS.md`.
2. Read `.agents/skills/survey-corps/SKILL.md`.
